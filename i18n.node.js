...
let reservedWords = require('./reserved18n.json'); // Load reserved words from JSON file

const targetDir = 'src'; // Define the starting directory
// const targetDir = 'research'; // Define the starting directory
const namespace = 'easy-code-manager'; // Define the namespace for the translation strings

const finalFile = 'app/Services/Trans.php'; // Define the file to replace the translation strings
